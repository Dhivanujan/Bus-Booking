        ...
        <div className="glass-panel p-8 md:p-10 mb-14 flex flex-col lg:flex-row gap-8 items-center justify-between">
          <div className="max-w-2xl">
            ...
            <p className="section-subtitle mt-3">
              Book premium intercity buses with live tracking,
              panoramic cabins, and AI-powered routes.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 pb-12">
          ...
          <div>
            ...
            <p className="mt-6 text-[#AAB6CC] leading-[1.8] text-[0.96rem]">
              Redefining premium intercity transportation with cinematic comfort
              and intelligent booking.
            </p>
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-[0.24em] text-[#73839B] mb-6">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              {[Globe, Camera, MessageCircle].map((Icon, i) => (
                <button
                  key={i}
                  className="icon-tile text-[#C7D0E0] hover:text-white transition-all duration-300 hover:scale-105"
                >
                  <Icon size={18} />
                </button>
              ))}
